...
Begin VB.Form FUserAccounts 
   ...
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   Picture         =   "FUserAccounts.frx":000C
   ScaleHeight     =   4935
   ScaleWidth      =   10710
   ...
   Begin TabDlg.SSTab SSTUsetAccounts 
      ...
      EndProperty
      TabCaption(0)   =   "User"
      TabPicture(0)   =   "FUserAccounts.frx":1FEC4E
      ...
      Tab(0).Control(3)=   "TPassword"
      Tab(0).Control(3).Enabled=   0   'False
      Tab(0).Control(4)=   "CoUsername"
      Tab(0).Control(4).Enabled=   0   'False
      Tab(0).Control(5)=   "Label2"
      Tab(0).Control(5).Enabled=   0   'False
      Tab(0).Control(6)=   "Label3"
      Tab(0).Control(6).Enabled=   0   'False
      Tab(0).Control(7)=   "CoUserRights"
      Tab(0).Control(7).Enabled=   0   'False
      Tab(0).Control(8)=   "ccl4(1)"
      Tab(0).Control(8).Enabled=   0   'False
      Tab(0).Control(9)=   "ccl4(0)"
      Tab(0).Control(9).Enabled=   0   'False
      Tab(0).Control(10)=   "ccl4(2)"
      Tab(0).Control(10).Enabled=   0   'False
      Tab(0).Control(11)=   "MUserGrid"
      Tab(0).Control(11).Enabled=   0   'False
      Tab(0).Control(12)=   "CCloseUser"
      Tab(0).Control(12).Enabled=   0   'False
      Tab(0).Control(13)=   "CRemoveUser"
      Tab(0).Control(13).Enabled=   0   'False
      Tab(0).Control(14)=   "CSaveUser"
      Tab(0).Control(14).Enabled=   0   'False
      Tab(0).ControlCount=   15
      TabCaption(1)   =   "Rights"
      TabPicture(1)   =   "FUserAccounts.frx":1FEC6A
      Tab(1).ControlEnabled=   0   'False
      Tab(1).Control(0)=   "CSaveRights"
      Tab(1).Control(0).Enabled=   0   'False
      Tab(1).Control(1)=   "CRemoveRights"
      Tab(1).Control(1).Enabled=   0   'False
      Tab(1).Control(2)=   "CCloseRights"
      Tab(1).Control(2).Enabled=   0   'False
      Tab(1).Control(3)=   "MRightsGrid"
      Tab(1).Control(3).Enabled=   0   'False
      Tab(1).Control(4)=   "ccl4(5)"
      Tab(1).Control(4).Enabled=   0   'False
      Tab(1).Control(5)=   "ccl4(4)"
      Tab(1).Control(5).Enabled=   0   'False
      Tab(1).Control(6)=   "ccl4(3)"
      Tab(1).Control(6).Enabled=   0   'False
      Tab(1).Control(7)=   "CoRights"
      Tab(1).Control(7).Enabled=   0   'False
      Tab(1).Control(8)=   "Label4"
      Tab(1).Control(8).Enabled=   0   'False
      Tab(1).Control(9)=   "Image2"
      Tab(1).Control(9).Enabled=   0   'False
      Tab(1).Control(10)=   "Image4"
      Tab(1).Control(10).Enabled=   0   'False
      Tab(1).ControlCount=   11
      Begin VB.CommandButton CSaveUser 
         Height          =   505
         Left            =   225
         Picture         =   "FUserAccounts.frx":1FEC86
         Style           =   1  'Graphical
         TabIndex        =   15
         Top             =   4170
         Width           =   1365
      ...
      Begin VB.CommandButton CRemoveUser 
         Height          =   505
         Left            =   1935
         Picture         =   "FUserAccounts.frx":2010E8
         Style           =   1  'Graphical
         TabIndex        =   6
         Top             =   4170
         Width           =   1365
      ...
      Begin VB.CommandButton CCloseUser 
         Height          =   505
         Left            =   3645
         Picture         =   "FUserAccounts.frx":20354A
         Style           =   1  'Graphical
         TabIndex        =   5
         Top             =   4170
         Width           =   1365
      ...
      Begin VB.CommandButton CSaveRights 
         Height          =   505
         Left            =   -74760
         Picture         =   "FUserAccounts.frx":2059AC
         Style           =   1  'Graphical
         TabIndex        =   4
         Top             =   4155
         Width           =   1365
      ...
      Begin VB.CommandButton CRemoveRights 
         Height          =   505
         Left            =   -73065
         Picture         =   "FUserAccounts.frx":207E0E
         Style           =   1  'Graphical
         TabIndex        =   3
         Top             =   4155
         Width           =   1365
      ...
      Begin VB.CommandButton CCloseRights 
         ...
         Height          =   505
         Left            =   -71370
         Picture         =   "FUserAccounts.frx":20A270
         Style           =   1  'Graphical
         TabIndex        =   2
         Top             =   4155
         Width           =   1365
      ...
      Begin VB.Image Image4 
         Height          =   10215
         Left            =   -75000
         Picture         =   "FUserAccounts.frx":40B314
         Top             =   360
         Width           =   15345
      End
   End
...
Private Sub newRightDetails()
    ...
    MRightsGrid.Rows = 0
    MRightsGrid.AddItem "1" & vbTab & "Masters" & vbTab & "Disabled" & vbTab & "MMasters" & vbTab & "A" & vbTab & "1" & vbTab & ""
    MRightsGrid.AddItem "2" & vbTab & "Transactions" & vbTab & "Disabled" & vbTab & "MTransactions" & vbTab & "A" & vbTab & "2" & vbTab & ""
    MRightsGrid.AddItem "3" & vbTab & "Reports" & vbTab & "Disabled" & vbTab & "MReports" & vbTab & "A" & vbTab & "3" & vbTab & ""
    MRightsGrid.AddItem "4" & vbTab & "Settings" & vbTab & "Disabled" & vbTab & "MSettings" & vbTab & "A" & vbTab & "4" & vbTab & ""
    
    MRightsGrid.AddItem "5" & vbTab & "Item Master" & vbTab & "Disabled" & vbTab & "MMItemMaster" & vbTab & "B" & vbTab & "5" & vbTab & "1"
    MRightsGrid.AddItem "6" & vbTab & "Customer Master" & vbTab & "Disabled" & vbTab & "MMCustomerMaster" & vbTab & "B" & vbTab & "6" & vbTab & "1"
    MRightsGrid.AddItem "7" & vbTab & "Supplier Master" & vbTab & "Disabled" & vbTab & "MMSupplierMaster" & vbTab & "B" & vbTab & "7" & vbTab & "1"
    MRightsGrid.AddItem "8" & vbTab & "Account Master" & vbTab & "Disabled" & vbTab & "MMAccountMaster" & vbTab & "B" & vbTab & "8" & vbTab & "1"
    MRightsGrid.AddItem "9" & vbTab & "Opening Stock" & vbTab & "Disabled" & vbTab & "MTOpeningStock" & vbTab & "B" & vbTab & "9" & vbTab & "2"
    MRightsGrid.AddItem "10" & vbTab & "Purchase" & vbTab & "Disabled" & vbTab & "MTPurchase" & vbTab & "B" & vbTab & "10" & vbTab & "2"
    MRightsGrid.AddItem "11" & vbTab & "Sales" & vbTab & "Disabled" & vbTab & "MTRetailsales" & vbTab & "B" & vbTab & "11" & vbTab & "2"
    MRightsGrid.AddItem "12" & vbTab & "Purchase Return" & vbTab & "Disabled" & vbTab & "MTPurchaseReturn" & vbTab & "B" & vbTab & "12" & vbTab & "2"
    MRightsGrid.AddItem "13" & vbTab & "Sale Return" & vbTab & "Disabled" & vbTab & "MTSaleReturn" & vbTab & "B" & vbTab & "13" & vbTab & "2"
    MRightsGrid.AddItem "16" & vbTab & "Payment" & vbTab & "Disabled" & vbTab & "MTPayment" & vbTab & "B" & vbTab & "16" & vbTab & "2"
    MRightsGrid.AddItem "17" & vbTab & "Receipt" & vbTab & "Disabled" & vbTab & "MTReceipt" & vbTab & "B" & vbTab & "17" & vbTab & "2"
    MRightsGrid.AddItem "18" & vbTab & "Purchase Register" & vbTab & "Disabled" & vbTab & "MRPurchaseRegister" & vbTab & "B" & vbTab & "18" & vbTab & "3"
    MRightsGrid.AddItem "19" & vbTab & "Sale Register" & vbTab & "Disabled" & vbTab & "MRSaleRegister" & vbTab & "B" & vbTab & "19" & vbTab & "3"
    MRightsGrid.AddItem "20" & vbTab & "Summary Register" & vbTab & "Disabled" & vbTab & "MRSummaryRegister" & vbTab & "B" & vbTab & "20" & vbTab & "3"
    MRightsGrid.AddItem "21" & vbTab & "Customer Wise Sales Register" & vbTab & "Disabled" & vbTab & "MRCustomerWiseSalesRegister" & vbTab & "B" & vbTab & "21" & vbTab & "3"
    MRightsGrid.AddItem "22" & vbTab & "Item Wise Report" & vbTab & "Disabled" & vbTab & "MRItemWiseReport" & vbTab & "B" & vbTab & "22" & vbTab & "3"
    MRightsGrid.AddItem "23" & vbTab & "Day Book" & vbTab & "Disabled" & vbTab & "MRDayBook" & vbTab & "B" & vbTab & "23" & vbTab & "3"
    MRightsGrid.AddItem "23" & vbTab & "Cash Book" & vbTab & "Disabled" & vbTab & "MRDayBook" & vbTab & "B" & vbTab & "23" & vbTab & "3"
    MRightsGrid.AddItem "23" & vbTab & "Cash In Hand" & vbTab & "Disabled" & vbTab & "MRDayBook" & vbTab & "B" & vbTab & "23" & vbTab & "3"
    MRightsGrid.AddItem "24" & vbTab & "Ledger Report" & vbTab & "Disabled" & vbTab & "MRAccountsRegister" & vbTab & "B" & vbTab & "24" & vbTab & "3"
    MRightsGrid.AddItem "25" & vbTab & "OutStanding Register" & vbTab & "Disabled" & vbTab & "MROutStandingReport" & vbTab & "B" & vbTab & "25" & vbTab & "3"
    MRightsGrid.AddItem "26" & vbTab & "BillwiseAccountsRegister" & vbTab & "Disabled" & vbTab & "MRBillwiseAccountsRegister" & vbTab & "B" & vbTab & "26" & vbTab & "3"
    MRightsGrid.AddItem "27" & vbTab & "Stock Register" & vbTab & "Disabled" & vbTab & "MRStockRegister" & vbTab & "B" & vbTab & "27" & vbTab & "3"
    MRightsGrid.AddItem "28" & vbTab & "Warranty Register " & vbTab & "Disabled" & vbTab & "MRWarrantyRegister" & vbTab & "B" & vbTab & "28" & vbTab & "3"
    MRightsGrid.AddItem "29" & vbTab & "Rate Comparison" & vbTab & "Disabled" & vbTab & "MRRateComparison" & vbTab & "B" & vbTab & "29" & vbTab & "3"
    MRightsGrid.AddItem "30" & vbTab & "MinimumStockComparison" & vbTab & "Disabled" & vbTab & "MRMinimumStockComparison" & vbTab & "B" & vbTab & "30" & vbTab & "3"
    MRightsGrid.AddItem "31" & vbTab & "Backup" & vbTab & "Disabled" & vbTab & "MSBackup" & vbTab & "B" & vbTab & "31" & vbTab & "4"
    MRightsGrid.AddItem "32" & vbTab & "Restore" & vbTab & "Disabled" & vbTab & "MSRestore" & vbTab & "B" & vbTab & "32" & vbTab & "4"
    MRightsGrid.AddItem "33" & vbTab & "User Accounts" & vbTab & "Disabled" & vbTab & "MSUserAccounts" & vbTab & "B" & vbTab & "33" & vbTab & "4"
    MRightsGrid.AddItem "34" & vbTab & "Change Password" & vbTab & "Disabled" & vbTab & "MSChangePassword" & vbTab & "B" & vbTab & "34" & vbTab & "4"
