...
Begin VB.Form FMain 
   ...
   Begin VB.Menu MTransactions 
      ...
      End
      Begin VB.Menu MTSaleReturn 
         Caption         =   "Sales Return"
      End
      Begin VB.Menu MAc 
         Caption         =   "-"
      End
      Begin VB.Menu MTOpeningBalance 
   ...
   Begin VB.Menu MReports 
      Caption         =   "Reports"
      Begin VB.Menu MRPurchaseSummary 
         Caption         =   "Purchase/Purchase Return Summary"
      End
      Begin VB.Menu MRSaleSummary 
         Caption         =   "Sales/Sales Return Summary"
      End
      Begin VB.Menu MRSaleProfitOrLoss 
         Caption         =   "Sales - Profit Or Loss Report"
      End
      Begin VB.Menu MRd 
         Caption         =   "-"
      End
      ...
      Begin VB.Menu Mrb 
         Caption         =   "-"
      End
      Begin VB.Menu MROutstandingPayable 
         Caption         =   "Outstanding Payable Report"
      End
      Begin VB.Menu MROutstandingReceivable 
         Caption         =   "Outstanding Receivable Report"
      End
      Begin VB.Menu MRC 
         Caption         =   "-"
      End
      ...
      End
      Begin VB.Menu MRMinimumStock 
         Caption         =   "Minimum Stock Report"
      End
      Begin VB.Menu MRWarantyReport 
         Caption         =   "Warranty Report"
      End
      Begin VB.Menu MRRateComparison 
         Caption         =   "Rate Comparison"
      End
      Begin VB.Menu MOCustomerWiseSaleReport 
         Caption         =   "Customer Wise Sales Report"
      End
      Begin VB.Menu MOItemWiseSaleReport 
   ...
   Begin VB.Menu MMasters 
      Caption         =   "Masters"
      Begin VB.Menu MMItemMaster 
         Caption         =   "Item Master"
      End
      Begin VB.Menu Ma 
         Caption         =   "-"
      End
      Begin VB.Menu MMCustomerMaster 
         Caption         =   "Customer Master"
      End
      Begin VB.Menu ME 
         Caption         =   "-"
      End
      Begin VB.Menu MMSupplierMaster 
