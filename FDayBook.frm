...
Dim lRowCount As Long, lColCount As Long
  ...
  ' Assign the data to Excel...
    ...
    oExcelSheet.Cells(1, 1).Value = "Day Book From " & Format(DTPFrom.Value, "dd-MM-yyyy") & " To " & Format(DTPTo.Value, "dd-MM-yyyy")
...
On Error Resume Next
    ...
    Kill App.Path & "\Reports\Day Book " & Format(Date, "dd-MMM-yyyy") & ".xlsx"

  ' Save the file as a native XLS file...
    oExcel.SaveAs App.Path & "\Reports\Day Book " & Format(Date, "dd-MMM-yyyy") & ".xlsx"
  ...
  ' Close the OLE object and remove it...
    ...
    xlTmp.Visible = True
    xlTmp.Workbooks.Open App.Path & "\Reports\Day Book " & Format(Date, "dd-MMM-yyyy") & ".xlsx"
